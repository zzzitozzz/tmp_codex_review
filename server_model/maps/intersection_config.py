...
INTERSECTION_MAP_CONFIG = MapConfig(
    ...
    visual_follow_R_max=5.0,
    visual_follow_fov_deg=120.0,
    visual_follow_d0=1.2,
    visual_follow_p=2.0,
    visual_follow_alpha_max=0.25,
    visual_follow_update_every_steps=2,
    visual_follow_ema_beta=0.2,
    visual_follow_vis_block="simple",
    visual_follow_same_dir_deg=60.0,
